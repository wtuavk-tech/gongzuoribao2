      ...
      {tabList.map((tab) => {
        ...
        return (
          <button
            ...
            className={`
              relative flex flex-col items-center justify-center gap-2 py-3 rounded-xl transition-all duration-200 border
              ${isActive 
                ? 'bg-white border-blue-200 shadow-sm ring-1 ring-blue-100 transform scale-[1.02]' 
          ...
          >
            {/* Icon Container */}
            <div 
              className="w-10 h-10 rounded-full flex items-center justify-center text-white shadow-sm transition-transform duration-200"
